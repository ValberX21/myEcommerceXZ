        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerZip = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    CustomerCountry = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CustomerPassword = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    CustomerToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CustomerRole = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CustomerActive = table.Column<bool>(type: "bit", nullable: false),
                    CustomerCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CustomerModified = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
